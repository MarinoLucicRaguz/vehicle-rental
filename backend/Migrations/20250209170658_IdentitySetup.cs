        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ExternalReservationId = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "numeric", nullable: false),
                    Currency = table.Column<string>(type: "text", nullable: false),
                    RentalPeriod = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationVehicles", x => new { x.ReservationId, x.VehicleId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentalOptions_VehicleId",
                table: "RentalOptions",
                column: "VehicleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_DefaultLocationId",
                table: "Vehicles",
